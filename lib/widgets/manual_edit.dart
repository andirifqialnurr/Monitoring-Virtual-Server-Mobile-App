...
class ResourceInfoCard extends StatefulWidget {
  final String title;
  final num maxValue;
  ...
  @override
  State<ResourceInfoCard> createState() => _ResourceInfoCardState();
}

class _ResourceInfoCardState extends State<ResourceInfoCard> {
  ...
  Widget build(BuildContext context) {
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration.collapsed(
                          hintText: widget.vms!.vmid.toString(),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration.collapsed(
                          hintText: widget.vms!.cpus.toString(),
                          hintStyle: subtitleTextStyle,
                        ),
                      ),
                    ),
    ...
    Widget diskInput() {
      String maxDiskSizeInGB = convertToGB(widget.vms!.maxdisk!);
      return Container(
        margin: const EdgeInsets.only(top: 30),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
    ...
    Widget memInput() {
      String formattedMaxMem = (widget.vms!.maxmem! >= 1073741824)
          ? '${(widget.vms!.maxmem! / 1073741824).toStringAsFixed(2)} GB'
          : '${(widget.vms!.maxmem! / 1048576).toStringAsFixed(2)} MB';
